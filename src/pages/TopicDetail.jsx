...
function TopicDetail() {
  ...
  return (
    <div className="topic-detail">
      ...
      <div className="topic-detail__actions" style={{ marginTop: '3rem', display: 'flex', gap: '1rem', flexWrap: 'wrap', animation: 'slideUp 0.5s ease-out' }}>
        <Link 
          to={`/quiz/flashcards?topic=${topic.category}`} 
          className="topic-detail__action-btn"
          style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 1.5rem', background: 'var(--color-primary)', color: 'white', textDecoration: 'none', borderRadius: '12px', fontWeight: 'bold', transition: 'transform 0.2s', flex: 1, justifyContent: 'center' }}
        >
        ...
        <Link 
          ...
          className="topic-detail__action-btn"
          style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 1.5rem', background: 'white', color: 'var(--color-primary)', border: '2px solid var(--color-primary)', textDecoration: 'none', borderRadius: '12px', fontWeight: 'bold', transition: 'transform 0.2s', flex: 1, justifyContent: 'center' }}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="20" height="20">
